...
public enum ResourceImage implements Resource {
	BMP("/net/laubenberger/wichtel/image/test.bmp"), //$NON-NLS-1$
	GIF("/net/laubenberger/wichtel/image/test.gif"), //$NON-NLS-1$
	JPG("/net/laubenberger/wichtel/image/test.jpg"), //$NON-NLS-1$
	PNG("/net/laubenberger/wichtel/image/test.png"); //$NON-NLS-1$
